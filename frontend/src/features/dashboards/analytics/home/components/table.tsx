...
export const users = [
  {
    id: 1,
    name: "Tony Reichert",
    description: "kpi metrics from jan 2023, many graphs",
    status: "completed",
  },
  {
    id: 2,
...
const INITIAL_VISIBLE_COLUMNS = ["name", "description", "status", "actions"];
      ...
      <div className="flex flex-col gap-4 pt-5">
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">
            {users.length} dashboards
          </span>
          <label className="flex items-center border-none text-default-400 text-small">
            Rows per page:
            <select
